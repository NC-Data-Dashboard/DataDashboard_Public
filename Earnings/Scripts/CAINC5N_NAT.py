...
df.drop(['TableName','Region','IndustryClassification', 'Unit', 'Description'], axis=1, inplace=True)
...
linecodes = [10, 20, 30, 35, 50, 60, 70, 81, 82, 90, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 11000, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000, 2001, 2002, 2010, 2011, 2012]
...
df_melt = df.melt(id_vars =['GeoArea_FIPS','GeoArea_Name', 'LineCode'], var_name='Date', value_name='Published_Value')
