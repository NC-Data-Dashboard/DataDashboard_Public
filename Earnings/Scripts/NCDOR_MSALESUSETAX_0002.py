...
df = pd.read_excel(
    "https://files.nc.gov/ncdor/documents/reports/monthly_sales_9-20.xls", skiprows=9
)
...
# Rename columns
df = df.rename(columns={"County.1": "County", "and Purchases*": "09-01-20"})
df1 = df1.rename(columns={"County.1": "County", "and Purchases*.1": "09-01-20"})
