...
df37['Economic_Measure_Name'] = 'Monthly Retail Sales on which Sales and Use Tax Collection are based'
...
df = df.rename(columns = {'Description':'Economic_Measure_Name', 'GeoFIPS':'GeoArea_FIPS', 'GeoName':'GeoArea_Name'})
...
df_master['Data_Period_Begin_Datetime'] = df_master['Date'].dt.strftime('%m/1/%Y %#H:%M')
df_master = df_master.drop(['Date'], axis=1)

# North Central
df_master.loc[df_master['GeoArea_Name'].str.contains('Chatham|Durham|Edgecombe|Franklin|Granville|Harnett|Johnston|Lee|Nash|Orange|Person|Vance|Wake|Warren|Wilson', na=False), 'PZ_Name'] = 'North Central'

# Northeast
df_master.loc[df_master['GeoArea_Name'].str.contains('Beaufort|Bertie|Camden|Chowan|Tyrrell|Hyde|Currituck|Dare|Gates|Halifax|Hertford|Hyde|Martin|Northampton|Pasquotank|Perquimans|Pitt|Washington', na=False), 'PZ_Name'] = 'Northeast'

# Northwest
df_master.loc[df_master['GeoArea_Name'].str.contains('Avery|Alleghany|Alexander|Ashe|Burke|Caldwell|Catawba|McDowell|Mitchell|Watauga|Wilkes|Yancey', na=False), 'PZ_Name'] = 'Northwest'

# Piedmont-Triad
df_master.loc[df_master['GeoArea_Name'].str.contains('Alamance|Caswell|Davidson|Davie|Forsyth|Guilford|Randolph|Rockingham|Stokes|Surry|Yadkin', na=False), 'PZ_Name'] = 'Piedmont-Triad'

# South Central
df_master.loc[df_master['GeoArea_Name'].str.contains('Bladen|Columbus|Cumberland|Hoke|Montgomery|Moore|Richmond|Roberson|Sampson|Scotland', na=False), 'PZ_Name'] = 'South Central'

# Southeast
df_master.loc[df_master['GeoArea_Name'].str.contains('Jones|Brunswick|Carteret|Craven|Duplin|Greene|Lenoir|New Hanover|Onslow|Pamlico|Pender|Wayne', na=False), 'PZ_Name'] = 'Southeast'

# Southwest
df_master.loc[df_master['GeoArea_Name'].str.contains('Anson|Cabarrus|Cleveland|Gaston|Iredell|Lincoln|Mecklenburg|Rowan|Stanly|Union', na=False), 'PZ_Name'] = 'Southwest'

# Western
df_master.loc[df_master['GeoArea_Name'].str.contains('Graham|Buncombe|Cherokee|Clay|Haywood|Henderson|Jackson|Macon|Madison|Polk|Rutherford|Swain|Transylvania', na=False), 'PZ_Name'] = 'Western'

#Cape Fear
df_master.loc[df_master['GeoArea_Name'].str.contains('Brunswick|Columbus|New Hanover|Pender', na=False), 'WDB_Name'] = 'Cape Fear'

#Capital Area
df_master.loc[df_master['GeoArea_Name'].str.contains('Johnson|Wake', na=False), 'WDB_Name'] = 'Capital Area'

#Centralina
df_master.loc[df_master['GeoArea_Name'].str.contains('Anson|Cabarrus|Iredell|Lincoln|Rowan|Stanley|Union', na=False), 'WDB_Name'] = 'Centralina'

#Charlotte Works
df_master.loc[df_master['GeoArea_Name'].str.contains('Mecklenburgh', na=False), 'WDB_Name'] = 'Charlotte Works'

#Cumberland County
df_master.loc[df_master['GeoArea_Name'].str.contains('Cumberland', na=False), 'WDB_Name'] = 'Cumberland County'

#DavidsonWorks, Inc.
df_master.loc[df_master['GeoArea_Name'].str.contains('Davidson', na=False), 'WDB_Name'] = 'DavidsonWorks, Inc.'

#Durham
df_master.loc[df_master['GeoArea_Name'].str.contains('Durham', na=False), 'WDB_Name'] = 'Durham'

#Eastern Carolina
df_master.loc[df_master['GeoArea_Name'].str.contains('Carteret|Craven|Duplin|Greene|Jones|Lenoir|Onslow|Pamlico|Wayne', na=False), 'WDB_Name'] = 'Eastern Carolina'

#Gaston County
df_master.loc[df_master['GeoArea_Name'].str.contains('Gaston', na=False), 'WDB_Name'] = 'Gaston County'

#Greensboro/High Point/Guilford
df_master.loc[df_master['GeoArea_Name'].str.contains('Guilford', na=False), 'WDB_Name'] = 'Greensboro/High Point/Guilford'

#High Country
df_master.loc[df_master['GeoArea_Name'].str.contains('Alleghany|Ashe|Yancey|Avery|Mitchell|Watauga|Wilkes', na=False), 'WDB_Name'] = 'High Country'

#Kerr-Tar
df_master.loc[df_master['GeoArea_Name'].str.contains('Caswell|Franklin|Granville|Person|Vance|Warren', na=False), 'WDB_Name'] = 'Kerr-Tar'

#Lumber River
df_master.loc[df_master['GeoArea_Name'].str.contains('Bladen|Hoke|Richmond|Roberson|Scotland', na=False), 'WDB_Name'] = 'Lumber River'

#Mountain Area
df_master.loc[df_master['GeoArea_Name'].str.contains('Buncombe|Henderson|Madison|Transylvania', na=False), 'WDB_Name'] = 'Mountain Area'

#Northeastern
df_master.loc[df_master['GeoArea_Name'].str.contains('Camden|Chowan|Currituck|Dare|Gates|Hyde|Pasquotank|Perquimans|Washington|Tyrrell', na=False), 'WDB_Name'] = 'Northeastern'

#Northwest Piedmont
df_master.loc[df_master['GeoArea_Name'].str.contains('Davie|Forsyth|Rockingham|Stokes|Surry|Yadkin', na=False), 'WDB_Name'] = 'Northwest Piedmont'

#Region C
df_master.loc[df_master['GeoArea_Name'].str.contains('Cleveland|McDowell|Polk|Rutherford', na=False), 'WDB_Name'] = 'Region C'

#Region Q
df_master.loc[df_master['GeoArea_Name'].str.contains('Beaufort|Bertie|Hertford|Martin|Pitt', na=False), 'WDB_Name'] = 'Region Q'

#Regional Partnership
df_master.loc[df_master['GeoArea_Name'].str.contains('Alamance|Montgomery|Moore|Orange|Randolph', na=False), 'WDB_Name'] = 'Regional Partnership'

#Southwestern
df_master.loc[df_master['GeoArea_Name'].str.contains('Cherokee|Clay|Graham|Haywood|Macon|Jackson|Swain', na=False), 'WDB_Name'] = 'Southwestern'

#Triangle South
df_master.loc[df_master['GeoArea_Name'].str.contains('Chatham|Harnett|Sampson|Lee', na=False), 'WDB_Name'] = 'Triangle South'

#Turning Point
df_master.loc[df_master['GeoArea_Name'].str.contains('Edgecombe|Halifax|Nash|Northampton|Wilson', na=False), 'WDB_Name'] = 'Turning Point'

#Western Piedmont
df_master.loc[df_master['GeoArea_Name'].str.contains('Alexander|Burke|Caldwell|Catawba', na=False), 'WDB_Name'] = 'Western Piedmont'
