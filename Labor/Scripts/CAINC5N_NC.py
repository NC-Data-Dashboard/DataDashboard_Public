...
df_per_capita.to_sql('STG_BEA_CA5N_Per_Capita_Personal_Income', con=engine, if_exists='append', index=False)
...
Declare @ColNm		varchar(30)	-- holds the column name
	...
	Set	@GEOID_Type	= 'FIPS'		-- Identifies the standard for the GeoArea Tidentifier
	Set	@Record_Source	= 'BEA'		-- Code for the source of the data
	set @TableName = 'STG_BEA_CA5N_Earnings_by_Place_of_Work';   -- SOURCE TABLE *** NEEDS TO BE UPDATED MANUALLY!!!!!
	set @Measure_Business_Key = 'BEA_CA5N_0035';
	set @ColNm = 'YR_ONE'
	set @StartRow = 9;				-- **** NEEDS ADJUSTMENT DEPENDING ON INPUT *****
	set @DataPeriodKey = '9999'
...
Declare @ColNm		varchar(30)	-- holds the column name
	...
	Set	@GEOID_Type	= 'FIPS'		-- Identifies the standard for the GeoArea Tidentifier
	Set	@Record_Source	= 'BEA'		-- Code for the source of the data
	set @TableName = 'STG_BEA_CA5N_Population';   -- SOURCE TABLE *** NEEDS TO BE UPDATED MANUALLY!!!!!
	set @Measure_Business_Key = 'BEA_CA5N_0020';
	set @ColNm = 'YR_ONE'
	set @StartRow = 9;				-- **** NEEDS ADJUSTMENT DEPENDING ON INPUT *****
	set @DataPeriodKey = '9999'
...
Declare @ColNm		varchar(30)	-- holds the column name
	...
	Set	@GEOID_Type	= 'FIPS'		-- Identifies the standard for the GeoArea Tidentifier
	Set	@Record_Source	= 'BEA'		-- Code for the source of the data
	set @TableName = 'STG_BEA_CA5N_Personal_Income';   -- SOURCE TABLE *** NEEDS TO BE UPDATED MANUALLY!!!!!
	set @Measure_Business_Key = 'BEA_CA5N_0010';
	set @ColNm = 'YR_ONE'
	set @StartRow = 9;				-- **** NEEDS ADJUSTMENT DEPENDING ON INPUT *****
	set @DataPeriodKey = '9999'
