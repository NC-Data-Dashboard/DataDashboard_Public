...
df_backup.to_csv('./Backups/STG_FRED_Resident_Population_by_County_Thousands_of_Persons_Thoudands_of_Persons_BACKUP.txt')
...
Declare @ColNm		varchar(30)	-- holds the column name
	...
	set @TableName = 'STG_FRED_Resident_Population_by_County_Thousands_of_Persons';   -- SOURCE TABLE *** NEEDS TO BE UPDATED MANUALLY!!!!!
	Set @Measure_Business_Key = 'FRED_POP_00000';		-- Data Series Business Identifier   *** NEEDS TO BE UPDATED MANUALLY!!!!!
	set @ColNm = 'YR_ONE'
...
c.exectue("""/*****		Post_Observations.sql										*****/
