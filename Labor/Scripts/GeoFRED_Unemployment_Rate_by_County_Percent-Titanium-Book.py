...
Declare @ColNm		varchar(30)	-- holds the column name
	...
	set @TableName = 'STG_FRED_Unemployment_Rate_by_County_Percent';   -- SOURCE TABLE *** NEEDS TO BE UPDATED MANUALLY!!!!!
	Set @Measure_Business_Key = 'FRED_LAUCN_003A';		-- Data Series Business Identifier   *** NEEDS TO BE UPDATED MANUALLY!!!!!
	set @ColNm = 'YR_ONE'
