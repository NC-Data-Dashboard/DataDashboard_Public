...
df_backup.to_csv('./Backups/STG_FRED_All_Transactions_House_Price_Index__by_County_BACKUP.txt')
...
#Create new backup
c.execute('''sp_rename 'dbo.STG_FRED_All_Transactions_House_Price_Index_by_County',
'STG_FRED_All_Transactions_House_Price_Index_by_County_BACKUP';''')
