...
Declare @ColNm		varchar(30)	-- holds the column name
	...
	set @TableName = 'STG_ZLLW_County_Zhvi_AllHomes';   -- SOURCE TABLE *** NEEDS TO BE UPDATED MANUALLY!!!!!
	Set @Measure_Business_Key = 'ZLLW_CNTY_ZHVI0';		-- Data Series Business Identifier   *** NEEDS TO BE UPDATED MANUALLY!!!!!
	set @ColNm = 'YR_ONE'
